            ...
            <div className="qualification__sections">
                <div className={
                    ...
                    <div className="qualification__data">
                        <div>
                        <h3 className="qualification__title">Electronics Computer Technology</h3>
                            <span 
                            className="qualification__subtitle">King Mongkut's North Bangkok</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <h3 className="qualification__title">Diploma in Computer Technology</h3>
                            <span 
                            className="qualification__subtitle">Sisaket Technical colleague</span>
                            <div className="qualification__calendar">
                                <i className="uil uil-calendar-alt"></
                                i> 2021 - 2023
                            </div>
