            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Phraibueng12@gmail.com</span>

                        <a href="mailto:Phraibueng12@gmail.com" className="contact__button">Write me <i 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Sitthikorn Buasing</span>

                        <a href="https://facebook.com/sitthikorn.buasing" className="contact__button">Write me <i 
                        className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Stkbs_12</span>

                        <a href="https://www.instagram.com/stkbs_12/" className="contact__button">Write me <i 
                        className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
